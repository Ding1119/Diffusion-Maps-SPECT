# -*- coding: utf-8 -*-
"""
Created on Fri Dec 18 14:42:48 2020
...
image_path = "C:/Users/Ding1119/parkinson-classification-master/" 
train_dir = image_path + "all_2d_train" 
validation_dir = image_path + "all_2d_val"
...
sample_val_images_X, val_Y = next(val_data_gen)


# In[]


sample_training_images_X, sample_training_images_Y = next(train_data_gen)
#plotImages(sample_training_images)

sample_test_images_X, sample_test_images_Y = next(val_data_gen)

# In[]


train_X = sample_training_images_X
train_Y = np.argmax(sample_training_images_Y,axis=1)
test_X = sample_test_images_X
test_Y = np.argmax(sample_test_images_Y,axis=1)
...
def split_test_LB(data):
    ...
    train_indices_1=shuffled_indices[0:337]
    train_indices_2=shuffled_indices[337:1097]
...
# train the network
    ...
    #covn_base =tf.keras.applications.vgg19.VGG19(weights='imagenet',include_top=False)
    #covn_base = tf.keras.applications.xception.Xception(weights='imagenet',include_top=False)
#     covn_base = tf.keras.applications.resnet50.ResNet50(weights='imagenet',include_top=True, input_shape=(128,128,3))
...
#     model.add(tf.keras.layers.Dense(2, activation='softmax'))
    ...
    # tf.keras.layers.Conv2D(filters=96, kernel_size=(11,11), strides=(4,4), activation='relu', input_shape=(109,91,3)),
...
# np.save('accuracy_25_PPMI_DCNN.npy',accuracy1_) 
# np.save('sensitivity_25_PPMI_DCNN.npy',sensitivity1_) 
# np.save('specificity_25_PPMI_DCNN.npy',specificity1_)
# np.save('precision_25_PPMI_DCNN.npy',precision_)
# In[]
