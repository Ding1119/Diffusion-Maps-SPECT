...
import pandas as pd
LB_ = pd.read_csv(r"C:\Users\Ding1119\PyTorch-Spectral-clustering-master\12_11_PPMI_test\New_100_Label_2.csv")
...
train_X = train_X.reshape(630,3,128,128,3)
test_X = test_X.reshape(100,3,128,128,3)
...
#     model.add(tf.keras.layers.Dense(2, activation='softmax'))
    ...
    model = tf.keras.models.Sequential([
    tf.keras.layers.Conv3D(filters=8, kernel_size=(3,3,3), padding='same', activation='relu', 
                                  input_shape=(3,128,128,3)),
   # tf.keras.layers.BatchNormalization(),
    tf.keras.layers.Conv3D(filters=16, kernel_size=(3,3,3), padding='same', activation='relu'),
    #tf.keras.layers.BatchNormalization(),
...
np.save('accuracy_25_SPECT_3D_DCNN.npy',accuracy1_) 
np.save('sensitivity_25_SPECT_3D_DCNN.npy',sensitivity1_) 
np.save('specificity_25_SPECT_3D_DCNN.npy',specificity1_)
np.save('precision_25_SPECT_3D_DCNN.npy',precision_)
